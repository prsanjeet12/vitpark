...
import bussineuss from './images/online-banking.png'
...
const Services = () => {
  ...
  return (
    <div className='mt-[200px] mb-4'>
      {/* First grid for the first three services */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        {services.slice(0, 3).map((service, index) => (
          <div key={index} className="bg-white rounded-lg w-[460px] h-[400px] shadow-xl p-6 flex flex-col justify-between">
             <img src={service.img} alt="" className="h-20 w-20 text-center ml-[160px]" />
      ...
      {/* Second grid for the last two services */}
      <div className="grid grid-cols-1 md:grid-cols-2  ml-[240px] mt-3 mr-[160px] mb-9">
        {services.slice(3).map((service, index) => (
          <div key={index} className="bg-white rounded-lg w-[460px] h-[400px]  pl-5 shadow-lg p-6">
                <img src={service.img} alt="" className="h-20 w-20 text-center ml-[160px]" />
