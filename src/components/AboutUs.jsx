...
import aboutUsImage from './images/about.jpeg'; // Renamed the import to follow JavaScript naming conventions
...
const AboutUs = () => {
  ...
  <h2 className="text-4xl  
   font-bold mb-4 lg:mb-[100px] lg:text-left lg:ml-[260px] text-center">About Us</h2>
